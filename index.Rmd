...
## Change in the types of crime incidents (2010-2020)
...
ggplot(crime_by_year_type_ratio, aes(incident_type_primary, percentage, fill=incident_year)) +
  geom_col() +
  transition_time(as.numeric(incident_year)) +
  ease_aes('linear')
```
