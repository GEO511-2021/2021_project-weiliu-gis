---
title: "Stay safe!<br>Mapping the crime events in Buffalo, NY (2010-2021)"
author: "Wei Liu"
...
2. Census Block Groups (CBG) 2010 of the City of Buffalo

&nbsp; &nbsp; &nbsp; &nbsp; The CBG 2010 data is downloaded from Buffalo Open Data Portal. Block Groups are statistical divisions of census tracts, are generally defined to contain between 600 and 3,000 people.
...
```{r}
# Read the csv file of crime events form Buffalo Open Data Portal
...
crime_2010 <- crime_original %>%
  ...
  # filter by date and time (crimes recorded on or later than 2010-01-01 00:00:00)
