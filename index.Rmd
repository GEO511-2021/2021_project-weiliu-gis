...
crime_pre <- dplyr::select(crime_pre,
                           case_number, geoid10, incident_datetime, incident_year, incident_hour, parent_incident_type)
```
...
### Map of the Spatial distribution of the crime incident points (2019)
...
### Map of the Spatial distribution of the crime incidents by Census Block Group (2019)
...
crime_2019_count_by_CBG <- st_set_geometry(crime_2019_count_by_CBG, crime_2019_count_by_CBG$geometry)
```

```{r, message=FALSE, fig.align='center'}
pal <- colorNumeric(c('#edf8fb','#b3cde3','#8c96c6','#8856a7','#810f7c'), crime_2019_count_by_CBG$counts)
...
## Correlation Between Crime Incidents and Sociodemographic Characteristics
...
Buffalo_demo_crime <- Buffalo_demo %>%
  ...
  dplyr::select(black_r, white_r, aged_r, bachelor_r, income, population, counts) %>%
