...
We read the file of Census Block into the environment.

```{r, message=FALSE, results='hide'}
Buffalo_CB = st_read("data/Buffalo_CB.shp")
```

### Sociodemographic data

We use the tidycensus API to access U.S. Census data. The variables we want are population, 
